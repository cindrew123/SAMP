import argparse
import os
from cut_tool.util import util
import torch
#import cut_tool.models

from cut_tool import models
from cut_tool import data
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--inital_model_dir', type=str, default='/home/vipuser/trans/best_model/old_cut_original', help='inital models are saved here')
        # model parameters
        ...
        parser.add_argument('--netG', type=str, default='resnet_9blocks',
                            choices=['resnet_9blocks', 'resnet_6blocks', 'unet_256', 'unet_128', 'stylegan2',
                                     'smallstylegan2', 'resnet_cat','mine'], help='specify generator architecture')
    ...
    def gather_options(self):
        ...
        model_name = opt.model # model_name is cut
